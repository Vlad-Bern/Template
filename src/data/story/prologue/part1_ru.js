...
export const story = {
  ...
  meet_kagami: {
    ...
    lines: [
      ...
      nfx(
        "Лил дождь. Она подошла ко мне — близко, но не интимно — и протянула мне второй зонтик",
        m.sfx("umbrella_open"),
      ),
      sf(
        "kagami",
      ...
      say("ren", "М-м, да, мне так привычнее."),
      say(
        "kagami",
        "Хорошо, далее тебя ждёт небольшой тест на способности. Прошу за мной.",
      ),
      nfx(
        "И мы двинулись.",
        m.sfx("step_puddle"),
      ...
      say(
        "kagami",
        "Ты первый, кто прибыл в середине семестра. Обычно здесь учатся с самого начала, так что ты уже выделился.",
      ),
      say("ren", "Вот оно как..."),
      nfx(
      ...
      n("Я остановился. Я уставился в одну точку."),
      nfx(
  ...
  approach_girl: {
    ...
    lines: [
      ...
      n(
        "С каждым шагом детали становились чётче. Странная белая жидкость на ступнях. Нет даже намека на одежду.",
      ),
      nfx(
  ...
  quiz_intro: {
    ...
    lines: [
      ...
      n("Белые стены делали комнату ещё более пустой."),
      n("Два стола стояли друг напротив друга, рядом висела доска."),
      say("kagami", "Присаживайся."),
      n("На парте уже лежат лист бумаги и ручка."),
      ...
      nfx("Кагами поставила наши зонты в подставку и села напротив меня.", {
      ...
      say("kagami", "Таймер запустится, как только перевернёшь листок."),
      say("kagami", "Вопросы?"),
  ...
  quiz_q1_warn: {
    ...
    lines: [
      ...
      n(
        "Да вы вопросы эти читали? Может, это подстава? Она перепутала бумаги?",
      ),
  ...
  quiz_q2_stare: {
    ...
    lines: [
      ...
      n(
        "Довольно отчётливо я вижу и тёмный бюстгальтер, который выглядывает из-под блузки...",
      ),
      n("Кагами, да вы меня соблазняете?"),
      n("Член твердеет, натягивая мои штаны, но под партой этого не видно."),
      nfx("Я слегка улыбнулся и посмотрел ей в глаза.....", {
        bg: "/bg/common/quiz_room_kagamiPhone.webp",
        dialogStyle: "normal",
      }),
      n(
  ...
  quiz_pass_clean: {
    ...
    lines: [
      ...
      n("Она разочарована тем, что я сдал?"),
      nfx(
  ...
  quiz_pass_stared: {
    ...
    lines: [
      ...
      nfx("Она встала прямо напротив меня с линейкой в руке."),
  ...
  quiz_fail: {
    ...
    lines: [
      ...
      n(
        "Я мирно ждал результатов, как вдруг почувствовал, что Кагами поставила свою ногу на мой стул.",
        {
          ...m.stopBgm(),
        },
      ),
      ...
      n("Кагами сняла правую туфлю и поднесла ногу прямо к моему лицу."),
      sf("kagami", "Лижи.", {
  ...
  quiz_fail_lick: {
    ...
    lines: () => [
      ...
      nfx("Я едва прижал язык к нейлону и слегка провёл им по ткани."),
      ...
      n("…"),
      n("…"),
      n("Я лижу уже целую минуту. Когда она закончит?"),
      ...
      n("Мой член…"),
      nfx("Он начал упираться в натянувшуюся ткань штанов.", {
        ...m.sanity(-1),
      }),
      ...
      n("Что за мерзость..."),
      n(
        "Её чёрный нейлоновый носок... Он насквозь промок... Я вижу ккрасный лак на ногтях её пальцев сквозь носок.",
      ),
      ...
      n(
        "Я и сам не могу понять, что пугает меня больше: эта ситуация или мой стояк.",
      ),
      nfx("Унижение и похоть разрывают меня.", { ...m.sanity(-5) }),
      // stopBgm — через audio-поле, не через action
      n("Кагами наконец убрала ногу, я начал отдышиваться.", {
        ...m.stopBgm(),
      }),
      sf(
        "kagami",
  ...
  corridor_intro: {
    ...
    lines: () => [
      ...
      nfx("Мы поднимались на четвёртый этаж во всё той же полной тишине.", {
      ...
      n("Но моё внимание привлекла маленькая фотография."),
      nfx(
      ...
      say("ren", "Воу…"),
      n("У меня совершенно случайно вырвался тупорылый звук."),
      n("Но Кагами это проигнорировала."),
      n(
      ...
      nfx("Затем Кагами передала ключи мне.", {
        ...m.show("kagami", "neutral", "center"),
        ...m.sfx("key_door"),
      }),
      say(
        "kagami",
        "Запомни, ты живёшь во втором корпусе, на четвёртом этаже, в комнате 404.",
      ),
      ...
      say("kagami", "Ведь лучший способ научиться драться — это драка."),
      n("Так ли это?"),
      ...
      nfx("Кагами протянула мне телефон."),
      n("На вид самый обычный, на нём нет логотипа производителя"),
      say(
        "kagami",
      ...
      say(
        "kagami",
        "С его помощью ты хоть как-то сможешь отслеживать события в мире за пределами школы.",
      ),
      say(
        "kagami",
      ...
      say(
        "kagami",
        "Как и во всех школах, плохо себя ведёшь — получаешь наказание, хорошо — награду. Вопросы?",
      ),
  ...
  kagami_leaves: {
    ...
    lines: [
      ...
      say(
        "kagami",
        "Обращаться к администрации D-рангу не позволено. Но, конечно, ты всё ещё думаешь, что что-то здесь значишь.",
      ),
  ...
  tbc: {
    ...
    lines: () => [
      n(
        "Да, можно было бы заглянуть в телефон или осмотреться, но не сейчас. Я хочу просто уснуть.",
      ),
      ...
      nfx(
        "Эти первые часы здесь утомили меня сильнее, чем весь остальной день..",
        m.fx({ darkness: 1, noise: 0, duration: 500 }),
      ),
      n("А что меня ждёт дальше?"),
      n(
        "Мне начинает казаться... что ученики и учителя здесь уже давно окончательно ёбнулись...",
      ),
      n(
        "Да... Я уже проваливаюсь в сон... Такой прекрасный и тихий... Подальше от всего этого...",
      ),
      n("Вглубь..."),
    ],
