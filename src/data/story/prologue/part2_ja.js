...
export const story = {
  ...
  class_enter: {
    ...
    lines: [
      ...
      nfx("机の下には、スニーカーを履いた黒いストッキングの脚が見える……", {
      ...
      nfx(
        "カイラが完全にこちらを向き、足をさらに高く上げる。今度は文字どおり、俺のちんこに触れている！",
        m.psychoShake("ren"),
      ),
      say("ren", "カイラ、やめろ！"),
      say("kaira", "あっ！　あっ！　あっ！　もう硬くなってる！！！"),
      n(
        "何でそんな大声で言うんだよ？！　教室を見回すと、全員の視線を集めていた！",
      ),
      say(
        "kaira",
      ...
      n(
        "カイラはため息をつき、渋々少しだけ身体を離した。だが、足は俺の股間に乗せたままだ。",
      ),
      ...
      sf("kaira", "でも、運命そのものがこの子を私の隣に座らせたんだよ。", {
        choices: [
          ...
          { text: "彼女の図々しさを受け入れる", next: "class_kaira_submit" },
        ],
      }),
    ],
  },
  ...
  class_kaira_submit: {
    lines: [
      ...
      n("俺は何もしなかった。"),
      nfx(
        "時間だけが過ぎていく。彼女の足は俺の上に、顔は平静なまま、俺のちんこは臨戦態勢のまま。",
        {
  ...
  class_kaira_thighs_black: {
    lines: [
      ...
      say("kaira", "女の子が脱いだばかりのやつでね。そうでしょ？"),
  ...
  yuno_intro_continue: {
    lines: [
      ...
      say(
        "death",
        "ほら、甘そうなヒダでしょ！　すっごくきついんだから。信じていいよ。",
      ),
  ...
  locker_chase: {
    ...
    next: () => {
      ...
      "
          >
            Dランクの皆さん、プレイしていただき本当にありがとうございました！❤<br />
            以上が第二部です。<br />
            そして、第三部もあります。プロローグの最終章です。
          </span>`,
        `制作：V&Mai Studio
        各種AIの協力を得て制作`,
