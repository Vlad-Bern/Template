...
export const story = {
  ...
  bus_wakeup: {
    ...
    lines: [
      ...
      n("着いたのか？"),
      nfx(
        "バスは停車したままだった。エンジンの低い唸りが、窓を叩く雨音と混ざり合っていた。",
        {
          audio: [
  ...
  meet_kagami: {
    ...
    lines: [
      ...
      n(
        "鋭くも疲れた眼差しをした大人の女性だった。黒髪はきつくポニーテールに束ねられ、かすかに渋いワインの香りがした。",
      ),
      say("ren", "あの、はじめまして、俺は——"),
      say("kagami", "天野レン。知っている。"),
      nfx(
        "雨が降りしきる中、彼女は俺のすぐそばまで歩み寄り、もう一本の傘を差し出した。距離は近かったが、そこに親密さはなかった。",
        m.sfx("umbrella_open"),
      ),
      sf(
        "kagami",
      ...
      n(
        "そんな考えに必死でしがみつき、何もおかしくない、自分は安全だと言い聞かせようとした。",
      ),
      n("だが、視線を上げなければならなかった。"),
      say(
        "ren",
        "鏡先生、この学校について教えてもらえますか。小さな田舎町から転校してきたんで……",
      ),
      ...
      say(
        "kagami",
        "学期の途中で入学するのはあなたが初めてです。通常は学期の初めから在籍します。ですから、すでに目立っていますよ。",
      ),
      say("ren", "そういうことか……"),
      nfx(
  ...
  approach_girl: {
    ...
    lines: [
      ...
      n(
        "近づくほど細部がはっきりしてきた。足には奇妙な白い液体が付着している。衣服はひとかけらも身につけていない。",
      ),
      nfx(
      ...
      n("俺を見ている。とても静かな目で……"),
      n("いや、不安げなのか？判断できない。"),
      nfx("もう、彼女のすぐ目の前に立っている。", m.sanity(-5)),
      n("どうすればいい……？"),
    ],
    choices: [
  ...
  talk_to_girl: {
    ...
    lines: [
      ...
      say("ren", "くそっ、離せ！"),
      n(
        "しかし彼女は聞く耳を持たず、鎖を張りつめさせながら、じりじりと這い寄ってくる。",
      ),
      nfx(
        "バシッ。後頭部に傘が直撃した。",
  ...
  quiz_intro: {
    ...
    lines: [
      ...
      say("kagami", "ルールは簡単です。20分以内に8問に答えてください。"),
  ...
  quiz_q2_stare: {
    ...
    lines: [
      ...
      n("でかい……すごいな。"),
      n("何カップだ？　少なくともDカップはある。"),
      n("触ったらどんな感じだろう。"),
      n("今まで誰かに触らせたことくらい、あるんだろうな。"),
  ...
  quiz_q8: {
    id: "quiz_q8",
    lines: [
      n("問8：あなたはテストに不合格となった。どうする？", m.sfx("writing", 1)),
      n("A) 再試験を要求する"),
  ...
  quiz_pass_stared: {
    ...
    lines: [
      ...
      say(
        "kagami",
        "ですが、あなたは無遠慮に私を見つめ、明らかに一線を越えました。",
      ),
  ...
  quiz_punishment_kneel: {
    ...
    lines: [
      ...
      say(
        "kagami",
        "あなたはDランク。ただのゴミです。自分の担当者を見て涎を垂らすとは、あなたがどれほど下等かを証明しているだけですよ。",
      ),
      n("彼女は定規を少し強く押した。金属が皮膚に食い込む。"),
      say("ren", "あぐっ……"),
      say(
        "kagami",
        "この身分の差を忘れないでください。あなたにはよい教訓でしょう。立ちなさい。",
      ),
  ...
  quiz_fail_lick: {
    ...
    lines: () => [
      ...
      n(
        "味と匂いが一気に広がった。温かな肌、革靴、そしてローションのかすかな香り。",
      ),
      nfx("ナイロンにそっと舌を当て、軽く舐めた。"),
      say("kagami", "ふざけているのですか？"),
      say("kagami", "それが許しを乞う態度ですか？"),
      n("彼女はつま先を俺の舌にさらに強く押しつけた。"),
      nfx("足の親指が俺の唇に当たった。", {
        bg: "/bg/cg/prologue/quiz_room_footLicking3.webp",
        bgSpeed: 50,
      }),
      say("kagami", "そうです。足の指を一本ずつ、きちんと舐めなさい。"),
      ...
      n("もう一分は舐めてる。いつ終わるんだ？"),
      say("kagami", "もっと強く、レン！"),
      n("気づけば、俺は本気で彼女を満足させようとしていた。"),
      n("舌の動きをさらに速め、彼女の足の指を舐め続けた。"),
      n("どれだけ狂った状況でも……"),
      n("チンポが……"),
      ...
      ...(getFlag("kagamiStare")
        ? [
            sf(
              "kagami",
              "もっと本気でやりなさい、レン。好き勝手に私を眺めるのは楽しかったのでしょう？この味も気に入りましたか？",
      ...
      say(
        "kagami",
        "もっとも、こうして床に無様に転がっているあなたに、どれほど意味があるかは分かりませんが。",
      ),
  ...
  corridor_intro: {
    ...
    lines: () => [
      ...
      n("何かで隠せばいい。"),
      n(
        "考えていると、鏡はもう奥に進み、きしむ椅子に腰を下ろして足を組んでいた。",
        m.sfx("chair_sitting"),
      ),
      ...
      say(
        "kagami",
        "Fランクまで落ちないためには、最低でも欠席や遅刻をせず、基本的な規則を破らないことです。",
      ),
      say("ren", "上がるには？"),
      ...
      say(
        "ren",
        "なんであんな問題だったんですか？学力とは何の関係もないじゃないですか。",
      ),
      say("kagami", "そうでしょうか？"),
      say(
        "kagami",
        "私としては、ここで生き残るための基礎知識を正当に評価したつもりです",
      ),
  ...
  tbc: {
    ...
    lines: () => [
      ...
      nfx(
        "ここへ着いてからの数時間だけで、それまでの一日分以上に疲れ切った。",
        m.fx({ darkness: 1, noise: 0, duration: 500 }),
      ),
      n("この先、何が待ってる？"),
      n(
