  ...
  constructor() {
    ...
    this.uiTranslations = {
      ...
      ja: {
        ...
        sponsors_rank_notice: "Cランク以上のスポンサー · リストを開く",
        sponsors_rank_label: "Cランク",
        sponsors_modal_title: "Cランク",
